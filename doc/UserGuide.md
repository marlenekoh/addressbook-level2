...
### Adding a person: `add`
Adds a person to the address book. Shows a list of all persons in the address book after addition.<br>
...
Deletes the specified person from the address book. Irreversible. Shows a list of all persons in the address book after deleting.<br>
Format: `delete INDEX`
